...
func (c *userServiceClient) GetUserProfilesByIds(ctx context.Context, in *GetUserProfilesByIdsReq, opts ...grpc.CallOption) (*GetUserProfilesByIdsRes, error) {
	out := new(GetUserProfilesByIdsRes)
	err := c.cc.Invoke(ctx, "/user.UserService/GetUserProfilesByIds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_GetUserProfilesByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserProfilesByIdsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.UserService/GetUserProfilesByIds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserProfilesByIds(ctx, req.(*GetUserProfilesByIdsReq))
	}
	return interceptor(ctx, in, info, handler)
}
