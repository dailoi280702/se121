...
func (c *recommendationServiceClient) GetRelatedBlog(ctx context.Context, in *GetRelatedBlogReq, opts ...grpc.CallOption) (*GetRelatedBlogRes, error) {
	out := new(GetRelatedBlogRes)
	err := c.cc.Invoke(ctx, "/blog.RecommendationService/GetRelatedBlog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RecommendationService_GetRelatedBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRelatedBlogReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).GetRelatedBlog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.RecommendationService/GetRelatedBlog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetRelatedBlog(ctx, req.(*GetRelatedBlogReq))
	}
...
var RecommendationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "blog.RecommendationService",
