...
export default function AddComment({ blogId }: { blogId: Number }) {
  const { values, states, events } = useAddComment({ blogId })
  ...
  return (
    ...
    >
      <div className="relative mt-8">
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: values.errors.comment ? values.errors.comment : '\u2000',
          }}
        />
      </div>
      {/* submit buttons */}
      <div className="mt-2 flex items-center justify-end">
        <button
          className="ml-auto mr-3 h-10 rounded-full px-3 text-sm font-medium
          text-red-600 outline-none enabled:hover:bg-red-600/10"
          type="button"
