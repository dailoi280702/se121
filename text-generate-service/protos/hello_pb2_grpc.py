...
class HelloStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                response_deserializer=protos_dot_hello__pb2.HelloResponse.FromString,
                )
...
def add_HelloServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=protos_dot_hello__pb2.HelloResponse.SerializeToString,
            ),
    }
...
class Hello(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/hello.Hello/SayHello',
            ...
            protos_dot_hello__pb2.HelloResponse.FromString,
